...
const {todos, populate_todos, users, populate_users} = require('./seed/seed')

beforeEach(populate_todos);
...
describe('POST /users', () => {
    ...
    it('should not create a user if mail in use', function (done) {
        request(app)
            .post('/users')
...
describe('DELETE /users/me/token', () => {
    ...
    it('should remove token on logout', function (done) {
        request(app)
